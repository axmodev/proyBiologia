// To parse this data:
//
//   import { Convert, PokemonDescriptionResponse } from "./file";
//
//   const pokemonDescriptionResponse = Convert.toPokemonDescriptionResponse(json);
//
...
export class Convert {
    public static toPokemonDescriptionResponse(json: string): PokemonDescriptionResponse {
        return cast(JSON.parse(json), r("PokemonDescriptionResponse"));
    }

    public static pokemonDescriptionResponseToJson(value: PokemonDescriptionResponse): string {
        return JSON.stringify(uncast(value, r("PokemonDescriptionResponse")), null, 2);
    }
}
